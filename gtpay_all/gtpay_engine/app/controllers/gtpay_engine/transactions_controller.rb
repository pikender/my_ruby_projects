...
module GtpayEngine
  class TransactionsController < ApplicationController
    ...
    def create
      @transaction = GtpayEngine::GtPayTransaction.new(:gtpay_tranx_amt => 200, :gtpay_tranx_id => session[:gtpay_tranx_id], :gtpay_tranx_curr => "566")
    ...
    def find_transaction
      if @transaction = GtpayEngine::GtPayTransaction.where(:gtpay_tranx_id => params['gtpay_tranx_id']).first
